...
header_airline = ['airline_id', 'airline_name', 'alias',
                  'iata', 'icao', 'callsign', 'country_name', 'active']
...
nv_country = pd.DataFrame(
    [["Democratic People's Republic of Korea"]], columns=country.columns)
